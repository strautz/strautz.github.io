...
faecher[0]=new Array("AG-Ba","AG Band",26,0,2);
faecher[1]=new Array("AG-Ci","Chinesisch-AG",26,0,2);
faecher[2]=new Array("AG-En","Englisch AG",26,0,2);
faecher[3]=new Array("AG-Li","Literatur AG",26,0,2);
faecher[4]=new Array("AG-Ph","AG Physik",26,0,2);
faecher[5]=new Array("AG-Sa","AG Schach",26,0,2);
faecher[6]=new Array("AG-To","Toleranz AG",26,0,2);
faecher[7]=new Array("BI","Biologie",20,5,3);
faecher[8]=new Array("CH","Chemie",19,5,3);
faecher[9]=new Array("DE","Deutsch",1,5,3);
faecher[10]=new Array("DS","Darstellendes Spiel",6,0,3);
faecher[11]=new Array("EK","Erdkunde",9,5,3);
faecher[12]=new Array("EN","Englisch",2,5,3);
faecher[13]=new Array("FR","Französisch",2,5,3);
faecher[14]=new Array("FRN","Französisch neu",3,0,4);
faecher[15]=new Array("GE","Geschichte",8,5,3);
faecher[16]=new Array("GR","Griechisch",2,0,3);
faecher[17]=new Array("HE","Hebräisch",2,0,3);
faecher[18]=new Array("IF","Informatik",21,5,3);
faecher[19]=new Array("IT","Italienisch",2,0,3);
faecher[20]=new Array("ITN","Italienisch neu",3,0,4);
faecher[21]=new Array("KU","Kunst",4,5,3);
faecher[22]=new Array("LA","Latein",2,5,3);
faecher[23]=new Array("LAN","Latein neu",3,0,4);
faecher[24]=new Array("LAwf","Latein",2,0,2);
faecher[25]=new Array("MA","Mathematik",17,5,3);
faecher[26]=new Array("MU","Musik",5,5,3);
faecher[27]=new Array("NL","Niederländisch",2,0,3);
faecher[28]=new Array("NLN","Niederländisch neu",3,0,4);
faecher[29]=new Array("PA","Pädagogik",12,0,3);
faecher[30]=new Array("PH","Physik",18,5,3);
faecher[31]=new Array("PL","Philosophie",11,5,3);
faecher[32]=new Array("PO","Politik-Wirtschaft",7,5,3);
faecher[33]=new Array("RE","Evangelische Religionslehre",15,5,3);
faecher[34]=new Array("RK","Katholische Religionslehre",15,5,3);
faecher[35]=new Array("RL","Rechtskunde",10,0,3);
faecher[36]=new Array("RS","Russisch",2,5,3);
faecher[37]=new Array("RSN","Russisch neu",3,5,4);
faecher[38]=new Array("SF","Seminarfach",25,0,2);
faecher[39]=new Array("SN","Spanisch",2,5,3);
faecher[40]=new Array("SNN","Spanisch neu",3,5,4);
faecher[41]=new Array("SP","Sport",23,0,2);
faecher[42]=new Array("SPP","Sport",23,6,4);
faecher[43]=new Array("SPT","Sporttheorie",24,0,2);
faecher[44]=new Array("WI","Wirtschaftslehre",14,5,3);
faecher[45]=new Array("WN","Werte und Normen",16,0,3);
...
fachangebot[3][7]=["DS","KU","MU"];
fachangebot[3][8]=["BI","CH","DE","EN","FR","IF","LA","MA","PH","SN"];
